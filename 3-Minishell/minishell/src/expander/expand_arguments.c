...
/*                                                   +#+                      */
/*   Created: 2023/03/26 03:43:31 by pdong         #+#    #+#                 */
/*   Updated: 2023/03/26 17:44:28 by pdong         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include <minishell.h>

int32_t	trim_quotes2(char *str, char **trimmed)
{
	int32_t	i;
	int32_t	start;
	char	*tmp;
...
char	*trim_quotes(char *str)
{
	...
	start = trim_quotes2(str, &trimmed);
